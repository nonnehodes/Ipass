...
class TestAlgorithmDecisionTree(TestCase):
    def test_run(self):
        df = pd.read_csv('awayscores.csv')
        self.assertEqual(
            AlgorithmDecisionTree(df, 'e89c6764cb79f40313364589a5651c40', 'a7c03e28b1abf335193b3b20f3282837',
                                  'Breda').run(),
            6.0)
    ...
    def test_create_prediction_array(self):
        df = pd.read_csv('awayscores.csv')
        features = ['index', 'ref1', 'ref2', 'location']
        ...
        out = AlgorithmDecisionTree(df, 'e89c6764cb79f40313364589a5651c40', 'a7c03e28b1abf335193b3b20f3282837', 'Breda') \
    ...
    def expected_dict(self):
        return {'index': {0: 22.0}, 'ref1_041b0d41cac9e4bae468c10a0d0c3e18': {0: 0.0},
                ...
                'ref1_de0357e8215d96f7a61d49ee5e3c1005': {0: 0.0}, 'ref1_e89c6764cb79f40313364589a5651c40': {0: 0.0},
                ...
                'ref2_a7c03e28b1abf335193b3b20f3282837': {0: 0.0}, 'ref2_be17171577738e0dfb43c18143024f42': {0: 0.0},
                ...
                'ref2_ff6c0a290b7ebae41b211630d273b935': {0: 0.0}, 'location_Amersfoort': {0: 0.0},
                'location_Amersfoort (Vathorst)': {0: 0.0}, 'location_Breda': {0: 0.0}, 'location_Enschede': {0: 0.0},
                'location_Lent (Nijmegen)': {0: 0.0}, 'location_Utrecht': {0: 0.0}}
